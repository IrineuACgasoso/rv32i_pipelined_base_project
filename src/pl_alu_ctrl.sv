    ...
    always_comb begin
        case (ALUOp)
            ...
            2'b10: begin                // R-type: decodificar Funct
                case (Funct3)
                    3'h0: Operation = (Funct7 == 7'b0100000)? 4'd02 : 4'd01; // SUB ou ADD
                    3'h1: Operation = 4'd06; // SLL
                    3'h2: Operation = 4'd11;  // SLT
                    3'h4: Operation = 4'd03;  // XOR
                    3'h5: Operation = Funct7 == 7'b0100000 ? 4'd08 : 4'd07; // SRA ou SRL
            ...
            2'b11: begin // OP_IMM: decodificar Funct3/Funct7
                case (Funct3)

                    3'b000:
                        Operation = 4'd01; // ADDI

                    3'b001:
                        Operation = 4'd06; // SLLI

                    3'b010:
                        Operation = 4'd11; // SLTI

                    3'b101:
                        Operation = (Funct7 == 7'b0100000) ? 4'd08 : 4'd07; // SRAI/SRLI
                        
                    3'b110:
                        Operation = 4'd04; // ORI

                    3'b111:
                        Operation = 4'd05; // ANDI
